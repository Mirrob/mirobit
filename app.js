...
Object.assign(translations, {
  "Packages": "প্যাকেজ",
  "Bangladesh SME focused": "বাংলাদেশের SME ব্যবসার জন্য",
  ...
  "Automatic daily sales report": "স্বয়ংক্রিয় দৈনিক বিক্রয় রিপোর্ট",
  "Track daily sales, profit, and branch performance from one dashboard.": "এক ড্যাশবোর্ডে দৈনিক বিক্রয়, লাভ এবং শাখার পারফরম্যান্স দেখুন।",
  "Staff attendance & KPI tracking": "স্টাফ হাজিরা ও KPI ট্র্যাকিং",
  "Monitor attendance, tasks, approvals, and performance scores.": "হাজিরা, কাজ, অনুমোদন এবং পারফরম্যান্স স্কোর মনিটর করুন।",
  "Inventory low-stock alerts": "ইনভেন্টরি কম-স্টক সতর্কতা",
  "Get alerts before important stock runs out.": "গুরুত্বপূর্ণ স্টক শেষ হওয়ার আগেই সতর্কতা পান।",
  "Lead follow-up reminders": "লিড ফলোআপ রিমাইন্ডার",
  "Capture leads, assign them, and send follow-up reminders automatically.": "লিড সংগ্রহ, অ্যাসাইনমেন্ট এবং ফলোআপ রিমাইন্ডার অটোমেট করুন।",
  "Owner business overview dashboard": "মালিকের ব্যবসা ওভারভিউ ড্যাশবোর্ড",
  "Give owners a clear view of sales, expenses, staff, and operations.": "মালিকের জন্য বিক্রয়, খরচ, স্টাফ এবং অপারেশনের পরিষ্কার ভিউ দিন।",
